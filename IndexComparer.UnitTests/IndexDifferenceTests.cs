...
namespace IndexComparer.UnitTests
{
    ...
    public class IndexDifferenceTests
    {
        ...
        [TestMethod]
        public void IndexDifference_MatchingSet_Success()
        {
            PrimaryIndexes.Add(isp1);
            SecondaryIndexes.Add(iss1);

            IEnumerable<IndexDifference> Differences = IndexDifference.GetDifferences(PrimaryIndexes, SecondaryIndexes);
        ...
        [TestMethod]
        public void IndexDifference_EmptyFirstSet_Success()
        {
            SecondaryIndexes.Add(iss1);
        ...
        [TestMethod]
        public void IndexDifference_EmptySecondSet_Success()
        {
            PrimaryIndexes.Add(isp1);
        ...
        [TestMethod]
        public void IndexDifference_ExtraInFirstSet_NoMatchingDifferences_Success()
        {
            PrimaryIndexes.Add(isp1);
        ...
        [TestMethod]
        public void IndexDifference_ExtraInSecondSet_NoMatchingDifferences_Success()
        {
            PrimaryIndexes.Add(isp1);
            SecondaryIndexes.Add(iss1);
        ...
        [TestMethod]
        public void IndexDifference_OneMatchingDifference_Success()
        {
            PrimaryIndexes.Add(isp1);
            ...
            Assert.AreEqual("Index6", Differences.ElementAt(0).IndexName);
        }

        [TestMethod]
        public void IndexDifference_TwoMatchingDifferences_Success()
        {
            PrimaryIndexes.Add(isp1);
            PrimaryIndexes.Add(isp2);
            PrimaryIndexes.Add(isp3);
            ...
            Assert.AreEqual("Index6", Differences.ElementAt(0).IndexName);
            Assert.AreEqual("IndexX", Differences.ElementAt(1).IndexName);
        }
    }
}
